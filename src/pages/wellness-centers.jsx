  ...
  return (
    <div className="bg-[#faebe3]">
      ...
      <section
        ...
        style={{ backgroundImage: "url('https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68e53c2bf0c2fbec935083b6/3b2d2e497_Shade-by-Starpool-Design-Cristiano-Mino-.jpg')" }}
        role="img"
        aria-label="Tranquil wellness center spa with therapeutic ambient music and relaxation soundscapes">
        <div className="absolute inset-0 bg-black/40" />
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 px-4 animate-fade-in-up leading-tight">Calming &amp; motivating soundscapes, for rejuvenation & training</h1>
          <p className="text-base sm:text-lg md:text-xl max-w-3xl mx-auto text-white/80 px-4 animate-fade-in-up leading-relaxed" style={{ animationDelay: '0.2s' }}>Ultra-specialized ambient and biophilic sound layers that deepen mindfulness and elevate your revitalizing sessions.</p>
        </div>
      </section>
