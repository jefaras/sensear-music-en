...
export default function HomeTestNew() {
  ...
  useEffect(() => {
    ...
    // SEO setup code ... keep existing logic
    // Simplified for brevity in this specific file if mostly layout test
    // But duplicating full logic is safer to keep it working exactly the same
    ...
    // ... (keeping other SEO logic minimal for duplicate, or copy paste if needed. I'll include the scroll listener)
