    ...
    },
    {
      ...
      "hasOfferCatalog": {
        ...
        },
        {
          ...
          "itemOffered": {
            "@type": "Service",
            "name": "Event Soundtracks", // Updated name
        ...
        },
        {
          ...
          "itemOffered": {
            "@type": "Service",
            "name": "Audio Upgrades", // Updated name
  ...
  return (
    <div className="bg-[#faebe3]">
      ...
      <section
        ...
        role="img"
        aria-label="Professional music equipment and sound system setup for venue curation">
        ...
        <div
          ...
          style={{
            ...
            backgroundImage: "url(https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68e53c2bf0c2fbec935083b6/adc5c3e54_dcff3c9fa7fade1ad1dfe051c913ca7f.jpg)",
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center text-white">
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-6 animate-fade-in-up leading-tight">Four Signature Services: <br /> One cohesive sound strategy
          </h1>
          <p className="text-lg sm:text-xl text-white/80 leading-relaxed mb-8 animate-fade-in-up px-4" style={{ animationDelay: '0.2s' }}>Advisory, on-site playlists & immersive experiences, designed to make your brand sound unique.

          </p>
          <div className="animate-fade-in-up px-4" style={{ animationDelay: '0.4s' }}>
            <Link to={createPageUrl("ContactUs")}>
              <Button className="bg-neutral-50 text-black px-6 sm:px-8 py-6 text-base sm:text-lg font-semibold rounded-md inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-[#f0dfd5] group w-full sm:w-auto" aria-label="Get a free listening session consultation">
      ...
      <section className="py-20 animated-gradient" aria-labelledby="services-list-heading">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-stretch" role="list">
            ...
            {
              icon: Sparkles,
              title: "Event Soundtracks", // Renamed
              description: "Artfully selected, custom-curated soundtracks and seamless AV production that elevate events into immersive, unforgettable moments.",
              link: createPageUrl("event-soundtracks"), // URI updated
            ...
            },
            {
              ...
              link: createPageUrl("audio-upgrades"), // URI updated
