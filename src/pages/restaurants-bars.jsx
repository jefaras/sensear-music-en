          ...
          <div className="grid lg:grid-cols-[1fr_auto] gap-8 items-start">
            ...
            <div className="lg:order-1 lg:mt-[116px]">
              <p className="text-2xl md:text-3xl lg:text-4xl text-white leading-relaxed mb-6">
                The right restaurant playlist shapes dining atmosphere more than decor or lighting.
              </p>
              <p className="text-2xl md:text-3xl lg:text-4xl text-white leading-relaxed">
                <strong>SensEar</strong> designs soundscapes that match your menu, service flow & bar energy so every visit feels like the place to stay, not just stop by.
              </p>
            </div>
          </div>
        </div>
