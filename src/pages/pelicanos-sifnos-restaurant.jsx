  ...
  return (
    <div className="bg-[#faebe3]">
      ...
      <section className="py-20 bg-black text-white" aria-labelledby="cta-heading">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 id="cta-heading" className="text-3xl sm:text-4xl font-bold mb-6">Ready to transform your restaurant's atmosphere?</h2>
          <p className="text-lg sm:text-xl text-white/80 mb-8 px-4">
            Explore solutions for <Link to={createPageUrl("restaurants-bars")} className="underline hover:text-white font-semibold">Restaurants</Link> or other <Link to={createPageUrl("Industries")} className="underline hover:text-white font-semibold">industries we serve</Link>.
          </p>
          <Link to={createPageUrl("ContactUs")}>
            <Button size="lg" className="bg-gray-50 text-black px-6 py-6 text-sm font-medium leading-tight rounded-md inline-flex items-center justify-center gap-2 ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 h-11 hover:bg-[#f0dfd5] w-full sm:w-auto sm:px-8 sm:text-base md:text-lg whitespace-normal" aria-label="Schedule a restaurant sound consultation">Schedule a Restaurant Sound Consultation</Button>
          </Link>
        </div>
      </section>
