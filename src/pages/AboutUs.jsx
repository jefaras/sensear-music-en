...
export default function AboutUs() {
  ...
  {
    title: "From Brand Vision to Sonic Expression",
    description: "We translate business and emotional intent into music that feels natural, human, and completely on-brand.",
    icon: Lightbulb
  },
  {
    title: "Built for Hospitality",
    description: "We design audio for the full guest journey; fine-tuned for restaurants, bars, spas, upscale hotels and retail that care about detail.",
    icon: Building2
  },
  {
    title: "Modular, Scalable, Personalized",
    description: "Our strategy is never one-size-for-all. We adapt to your existing operating style, team, and rollout needs across several locations, matching our approach to your pace.",
    icon: SlidersHorizontal
  },
  {
    title: "We deeply Love Music",
    description: "We are curators, DJs and listeners who craft our services with taste, purpose, and passion, harnessing music's power to shift moods, shape spaces, and connect people.",
    icon: Heart
  }];
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <div className="w-full max-w-4xl relative" role="list">
              ...
              <div className="space-y-12" style={{ width: '100%' }}>
                ...
                {
                  year: "2010",
                  description: "George and Katerina meet while curating the soundtrack for an upscale wedding party. Their shared passion for unearthing hidden-gem grooves sparks a lasting creative partnership."
                },
                {
                  year: "2011",
                  description: "Under the moniker Midnight City, George & Katerina begin organizing and DJing exclusive parties. Specializing in dance-floor discoveries from the '70s, '80s and '90s, they cultivate a fiercely loyal crowd of groove aficionados."
                },
                {
                  year: "2018",
                  description: "Yannis attends one of Midnight City's signature events. Captivated by the vibe and deep-track selections, he becomes an instant—and devoted—fan."
                },
                {
                  year: "2023",
                  description: "As Yannis begins a BA in Hospitality Management, he and George explore their shared vision of founding a company to provide premium music-curation services for upscale venues and events."
                },
                {
                  year: "2025",
                  description: "After nearly two years of planning and brand development, Sensear officially launches. With Katerina crafting the visual identity and George & Yannis leading the curation, the company's first clients rave about their seamless, elevated approach to soundtrack design—solidifying Sensear's reputation from day one."
                }].
                map((item, index) =>
                <article key={index} className="relative" role="listitem">
                    ...
                    <div className="md:hidden flex gap-6">
                      ...
                      <div className="flex-grow min-w-0 bg-peach/30 rounded-xl p-6 backdrop-blur-sm">
                        <p className="text-base text-black/80 leading-relaxed">{item.description}</p>
                      </div>
                    </div>
      ...
      <section className="py-24" style={{ backgroundImage: "url('https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68e53c2bf0c2fbec935083b6/178049824_warmsilverfoilsample-Picsart-AiImageEnhancer.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }} aria-labelledby="team-heading">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8" role="list">
            ...
            {
              name: "John E. Farazoumis",
              role: "Co-Founder, Brand Strategy – Client Service",
              bio: "From his early DJ sets in Larissa to his studies in sound engineering in Athens, J.E.F. has always been guided by music's magnetic pull. He later co-founded a successful digital agency, gaining two decades of experience in web services and understanding client needs.\n\nAt SensEar, he shapes the brand's strategic direction and bridges the gap between creative vision and client experience across the hospitality sector.",
              image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68e53c2bf0c2fbec935083b6/3ab0ef28b_404e9e2e-13f6-48c5-b898-4b1cf7a6ef19.png",
              alt: "John E. Farazoumis - SensEar Co-Founder and Brand Strategy Director"
            },
            {
              name: "George Fameliaris",
              role: "Co-Founder, Music Curator – DJ – Sonic Identity Expert",
              bio: "George's lifelong passion for music deepened through a Master's degree at Goldsmiths, University of London, where he explored music in media. Back in Athens, he made his mark as a curator and DJ on radio and at venues, including as co-founder of the acclaimed Midnight City.\n\nAt SensEar, he crafts each venue's musical identity with precision, rhythm, and a sense of atmosphere that defines the brand's signature sound.",
              image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68e53c2bf0c2fbec935083b6/398e0cca3_84887785_172252324195148_2160204890159185920_n.jpg",
              alt: "George Fameliaris - SensEar Co-Founder and Chief Music Curator"
            },
            {
              name: "Katerina Karali",
              role: "Contributing Associate, Art Director – DJ – Music Curator",
              bio: "Katerina combines visual design and sound storytelling with a refined artistic sensibility. A veteran multimedia art director, she curates soundscapes for films, exhibitions, and private events.\n\nKnown for her instinctive selections and taste for rare grooves, she brings depth, texture, and a touch of the unexpected to SensEar's playlists.",
              image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/68e53c2bf0c2fbec935083b6/73ba1e2e2_86455570_172252364195144_3083930653335486464_n.jpg",
              alt: "Katerina Karali - SensEar Art Director and Music Curator"
            }].
            map((member, index) =>
            <article key={member.name} role="listitem" className="animate-fade-in-up" style={{ animationDelay: `${0.3 + index * 0.15}s` }}>
                <Card className="bg-white text-center p-8 shadow-lg overflow-hidden hover:shadow-2xl transition-shadow">
                  ...
                  <p className="text-black/70 text-left whitespace-pre-line">{member.bio}</p>
                </Card>
              </article>
            )}
          </div>
      ...
      <section className="bg-[#faebe3] text-black py-24" aria-labelledby="differentiators-heading">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-10" role="list">
            ...
            <article key={item.title} role="listitem" className="animate-fade-in-up" style={{ animationDelay: `${0.3 + index * 0.15}s` }}>
